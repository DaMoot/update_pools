...
Bulk update the 'pools' list inside Verus ccminer JSON config across multiple hosts using SSH and a common password. Features include:
 ...
 - switchpool trigger via telnet on localhost:4068 (remote) - Must have api enabled
